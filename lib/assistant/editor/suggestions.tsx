...
import { Suggestion as PreviewSuggestion } from '@/components/assistant/suggestion';
import type { Suggestion } from '@/lib/assistant/db/schema';
import { ArtifactKind } from '@/components/assistant/artifact';
